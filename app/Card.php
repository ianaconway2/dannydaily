    ...
    public static function seed()
    {
        $cards = [
            ...
            [
                ...
                'keyword'       => 'cat',
                'copy'          => 3,
                'image'         => '/cards/dd_cp.png',
                'description'   => 'One free Danny Deal',
                'show_upload'   => 0,
                'redeemable'    => 1,
                'completable'   => 0,
                'upload_finished' => 0,
            ...
            [
                'series'        => 'Danny Deal',
                'title'         => 'Dirty Dancing Night',
                'keyword'       => 'dirty',
                'copy'          => 1,
                'image'         => '/cards/dd_ddn.png',
                'description'   => 'One free Danny Deal',
                'show_upload'   => 0,
                'redeemable'    => 1,
                'completable'   => 0,
